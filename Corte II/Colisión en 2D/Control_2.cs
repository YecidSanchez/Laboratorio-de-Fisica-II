...
public class Control_2 : MonoBehaviour {
    ...
    void Start() {
        ...
        Sphere_1.GetComponent<Sphere_2>().setVelocidad(new Vector3(vx1, vy1, 0));
        Sphere_2.GetComponent<Sphere_2>().setVelocidad(new Vector3(vx2, vy2, 0));
    }
    ...
    void Update() {
        ...
        Vector3 vel1 = Sphere_1.GetComponent<Sphere_2>().getVelocidad();
        Vector3 vel2 = Sphere_2.GetComponent<Sphere_2>().getVelocidad();
